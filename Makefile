...
PACKAGE ?= helm-metrics-server
XRD_DIR := apis/metricsservers
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/metricsservers/standard.yaml
...
EXAMPLES := \
    examples/metricsservers/minimal.yaml:: \
    examples/metricsservers/standard.yaml::
...
render\:%:
	@example="examples/metricsservers/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
